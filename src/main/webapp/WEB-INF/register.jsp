...
<div class="signup-form">
  <form action="register" method="post">
    <h2>Inscription chez MyOffers</h2>
    <hr>
    ...
    <div class="form-group">
      <input type="email" class="form-control" name="tel" placeholder="téléphone" required="required">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label class="form-check-label"><input type="checkbox" required="required"> j'accepte les  <a href="#">les termes d'utilisation</a> &amp; <a href="#">politique de confidentialité</a></label>
    </div>
    <div class="form-group">
      <button type="submit" class="btn btn-primary btn-lg">Inscrire</button>
    </div>
  </form>
  <div class="hint-text">Déja inscrit? <a href="${pageContext.request.contextPath}/login">Connectez-vous ici</a></div>
</div>
